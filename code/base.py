...
parser.add_argument('--sample_folder', default='sample_generic_160', type=str, help='save results')
parser.add_argument('--Loss_Curve', default='Loss_Curve_generic_160', type=str, help='Loss Curve image file name')
parser.add_argument('--Prediction_Curve', default='Prediction_Curve_generic_160', type=str, help='Prediction Curve image file name')
parser.add_argument('--FID_score_Curve', default='FID_score_Curve_generic_160', type=str, help='FID score Curve image file name')
